...
public class Units {
    ...
    @Test
        ...
        assertTrue("Unit already exists!! " + newunit_a.get("OrgNumber"),
                   UnitHelper.verifyUnit(dadriver, (HashMap <String, String>) newunit_a, false, logger));
        ...
        UnitHelper.addUnit(dadriver, (HashMap <String, String>) newunit_a, true, logger);
        ...
        assertTrue("Mismatch in new unit profile " + newunit_a.get("OrgNumber"),
                   UnitHelper.verifyUnit(dadriver, (HashMap <String, String>) newunit_a, true, logger));
        ...
        UnitHelper.editUnit(dadriver, (HashMap <String, String>) newunit_aalt, true, logger);
        assertTrue("Mismatch in new unit profile " + newunit_aalt.get("OrgNumber"),
                   UnitHelper.verifyUnit(dadriver, (HashMap <String, String>) newunit_aalt, true, logger));
                  
        
        logger.info("----------------------------  Test: edit Unit switch to unit address  -----");

        newunit_aorig.put("GetInfoFromCharterOrg", "No");
        UnitHelper.editUnit(dadriver, (HashMap <String, String>) newunit_aorig, true, logger);
        assertTrue("Mismatch in new unit profile " + newunit_aorig.get("OrgNumber"),
                   UnitHelper.verifyUnit(dadriver, (HashMap <String, String>) newunit_aorig, true, logger));
        

        logger.info("----------------------------  Test: de-activate Unit -----");

        assertTrue("Error during edit Unit for " + newunit_aorig.get("OrgNumber"),
                   UnitHelper.editUnit(dadriver, (HashMap <String, String>) newunit_aorig, false, logger));
        assertTrue("Mismatch in new unit profile " + newunit_aorig.get("OrgNumber"),
                   UnitHelper.verifyUnit(dadriver, (HashMap <String, String>) newunit_aorig, false, logger));
